  ...
  return (
    <div className="space-y-10">
      <header className="space-y-4">
        <p className="text-sm uppercase tracking-[0.4em] text-brand">Contact</p>
        <h1 className="text-4xl font-semibold text-slate-900">与我们对话未来云与 AI</h1>
      ...
      <div className="grid gap-8 lg:grid-cols-[1.1fr_0.9fr]">
        <ContactForm />
        <div className="space-y-6 rounded-3xl border border-white/60 bg-white/70 backdrop-blur-xl backdrop-saturate-150 p-6 shadow-lg">
          <div>
          ...
          <div>
            <h2 className="text-xl font-semibold text-slate-900">地图</h2>
